...
2. If command provided: send with newline, wait 0.2s
3. Non-blocking read loop with timeout
4. Strip ANSI codes if requested
5. Gracefully exit and return captured output
```
